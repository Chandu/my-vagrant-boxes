...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |global_config|
	machines.each_pair do |name, options|
		global_config.vm.define name do |config|
			...
			#config.vm.synced_folder "G:\Github", "/fun", type: "smb",  :smb_username => 'chandu',  :owner=> 'chandu'
			...
			common_shell_commands.each { |x| config.vm.provision :shell, :inline =>  x }
